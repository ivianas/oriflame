let sec04 = document.querySelector("div.wrapper>div.section04>div.product");

let s04 = async () => {
    let res = await (await fetch("http://localhost:2000/section04")).json();
        ...
        sec04.innerHTML += `
            <div class="w-[48.8%] h-auto    ">
                ...
                <div class=" w-full h-auto bg-[#F6F6F6] relative rounded-[5px] !mb-[8px] overflow-hidden  ">
                    ...
                    <img class="imgsec04  transition-all duration-500 " src="${elem.img}">
    ...
    let secc04=document.querySelector("div.section04");
    let vie=secc04.querySelector("button.viesec04");
